...
from .ingress_service import IngressEvalService
...
class EvalService:
    def __init__(
        ...
        *,
        loaded: LoadedConfig,
        lark_client: LarkCliClient | None = None,
        backend_factory: BackendFactory | None = None,
    ) -> None:
        self.loaded = loaded
        self.base_dir = evals_base_dir(loaded)
        self.lark_client = lark_client or LarkCliClient(
        ...
        self.backend_factory = backend_factory or (
            lambda current: create_agent_backend(
                current.config, base_dir=current.base_dir
            )
        )
        self.capture_service = CaptureService(
            loaded=loaded, lark_client=self.lark_client
        )
